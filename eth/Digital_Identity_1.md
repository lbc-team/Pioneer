...
这包括:数字身份的明确定义和范围；它为你的产品或服务带来的价值；关于常见的身份解决方案(包括密钥对、链上id、oauth登录和自定义解决方案)了解些什么。

**第二部分分享了从你的身份基础上需要什么**

  这包括:它应该建立的关键标准；5个它必须支持的特性和能力；适合您的技术栈一个灵活的模型
...
![img](Digital_Identity_1.assets/68747470733a2f2f696d672e6c6561726e626c6f636b636861696e2e636e2f323032302f30382f31332f31353937323836363336383735302e6a7067) 
...
我应该实现oauth还是一个映射到键的IPFS哈希?但是如果用户旋转秘钥或使用多个秘钥呢?

**数据存储**:我应该存储数据在Textile ThreadsDB?但是我如何允许用户管理访问控制而不添加更多的键类型和摩擦呢?
...
# 📩 oauth 登录
 ...
 使用Oauth服务作为标识的问题: 
**后端复杂性**:需要构建和维护用户表，以跟踪oauth令牌、内部用户标识、用户的区块链帐户和其他用户信息(如资产、交易和数据)之间的内部映射。
...
**生态系统排除**:自定义解决方案将您的用户(和他们的身份)与更广泛的社区开发的未来与身份相关的进步隔离开来，例如更好的恢复选项、新的身份验证提供商、新的数据库和服务。为了便于使用，身份系统必须在密码学和模式中“使用同一种语言”，而定制解决方案通常不会这样做。 
